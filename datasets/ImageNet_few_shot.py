...
"""
This module provides data loading utilities for the ImageNet dataset. It includes classes for
...
Classes:
    SimpleDataset: Wraps around the ImageNet dataset for simple data loading.
...
Notes:
    - The `configs` module is expected to contain the path to the ImageNet dataset (`ImageNet_test_path`).
...
class SimpleDataset:
    """
    A simple dataset class that wraps around the ImageNet dataset for simple data loading.
