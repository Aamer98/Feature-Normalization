...
class SimpleDataset:
    """
    A simple dataset class that wraps around the tiered-ImageNet dataset for simple data loading.
    ...
    def __init__(self, transform, target_transform=identity, split=None):
        ...
        # Load the tiered-ImageNet dataset using ImageFolder
        self.d = ImageFolder(
            configs.tiered_ImageNet_path,
            transform=transform,
...
class TransformLoader:
    ...
    def parse_transform(self, transform_type):
        ...
        if transform_type in ['Scale_original', 'Resize_original']:
            # Resize to the exact image_size
