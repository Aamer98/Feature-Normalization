...
from models.PixelNorm import PixelNorm  # Import the custom PixelNorm layer
...
class BasicBlock(nn.Module):
    """Basic residual block used in ResNet-18 and ResNet-34 with PixelNorm.
    ...
    Args:
        ...
        feature_sizes (int, optional): Size of the feature map for PixelNorm. Default is 0.
    """
    expansion: int = 1
    ...
    def __init__(
        ...
        self.pn1 = PixelNorm([planes, feature_sizes])  # PixelNorm layer
        self.bn1 = norm_layer(planes)
        self.relu = nn.ReLU(inplace=True)

        # Second convolutional layer
        self.conv2 = conv3x3(planes, planes)
        self.pn2 = PixelNorm([planes, feature_sizes])  # PixelNorm layer
...
class Bottleneck(nn.Module):
    """Bottleneck residual block used in ResNet-50, ResNet-101, and ResNet-152 with PixelNorm.
    ...
    def __init__(
        ...
        self.pn1 = PixelNorm([width, feature_sizes])  # PixelNorm layer
        self.bn1 = norm_layer(width)

        # Second convolutional layer
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.pn2 = PixelNorm([width, feature_sizes])  # PixelNorm layer
        self.bn2 = norm_layer(width)

        # Third convolutional layer
        self.conv3 = conv1x1(width, planes * self.expansion)
        self.pn3 = PixelNorm([planes * self.expansion, feature_sizes])  # PixelNorm layer
...
class ResNet(nn.Module):
    """ResNet model class with PixelNorm layers.
    ...
    Args:
        ...
        norm_layer (callable, optional): Normalization layer. Default is nn.BatchNorm2d.
        feature_sizes (List[int], optional): List of feature map sizes for PixelNorm layers at different stages.
    """
    ...
    def __init__(
        ...
        self.pn1 = PixelNorm([self.inplanes, feature_sizes[0]])  # PixelNorm layer
    ...
    def _make_layer(
        ...
        Args:
            ...
            feature_sizes: Size of the feature map for PixelNorm.
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                PixelNorm([planes * block.expansion, feature_sizes]),  # PixelNorm layer
...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-18 model with PixelNorm.
...
def resnet34(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-34 model with PixelNorm.
...
def resnet50(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-50 model with PixelNorm.
...
def resnet101(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-101 model with PixelNorm.
...
def resnet152(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-152 model with PixelNorm.
...
def resnext50_32x4d(
    ...
    """Constructs a ResNeXt-50 32x4d model with PixelNorm.
...
def resnext101_32x8d(
    ...
    """Constructs a ResNeXt-101 32x8d model with PixelNorm.
...
def wide_resnet50_2(
    ...
    """Constructs a Wide ResNet-50-2 model with PixelNorm.
...
def wide_resnet101_2(
    ...
    """Constructs a Wide ResNet-101-2 model with PixelNorm.
